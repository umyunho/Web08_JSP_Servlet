...
<%
	...
	//서버에서 jsp파일로 전달되는 배열이나  ArrayList는 보통 request의 Attribute에 담겨온다.
	//이를 바로 반복 실행문에 적용하는 형식이 주로 사용됨
