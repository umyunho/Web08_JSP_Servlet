...
<body>
	...
	<!-- 
		1. 로그인 순서  
			...
			; 검색된 아이디가 없면 "아이디가 없습니다"  아이디가 있으면서 암호가 틀리면 "암호가 틀립니다"
			; 아이디도 있고 암호도 일치하면 로그인 성공
			
		2. 아이디와 암호의 검색 및 검증은 보통 서버내부에서  JAVA 프로그래밍으로 이루어집니다.
		...
		7. 데이터베이스도 아직 연동하기 전이니   유효한 아이디 / 비번 은  scott/1234 로 하겠습니다
