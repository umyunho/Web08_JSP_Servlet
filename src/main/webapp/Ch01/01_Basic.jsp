...
<body>
	...
	<!-- 
	JSP 는  JAVA SERVER PAGE 의 약자로, 웹페이내부에 프로그래밍 적인 요소를 추가하거나, 
	...
	<!--  HTML 로 페이지를 구성하던 중, JSP 에의한 컨텐츠가 중간에 나와야 한다면 필요한곳에 JSP 명령을 씁니다. -->
	<!-- 현재 jsp 파일안에 html 문법사이로 jsp 문법이 껴들어 코딩될때는 <% %>를 사용합니다 -->


	<!-- JSP 명령 사용법 -->   
	<%-- HTML 내에서 JSP 명령이  섞인 구문을 주석 처리 한느 기호 --%>
	<%-- <% %> --%>
